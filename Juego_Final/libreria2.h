...
{
	//   Se imprime por pantalla el nivel 0 de tabJug que contiene los barcos, y el nivel 1 de tabMaq que contiene el mar del enemigo y las bombas lanzadas.
...
void tocadoYHundido( char tablero[tamTab][tamTab][2], int fil, int col, int *leTocaA )
{
	/*
	 ...
	 En caso de que todas las partes del barco hayan sido tocadas, se marca el barco como hundido y se imprime por pantalla.
	 */
