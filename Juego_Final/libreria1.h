...
{
	/* Se recibe una matriz  con datos.
	 Se imprime por pantalla su contenido.*/
...
{
	/*
	   Se recibe una matriz 
	   Se recibe una cadena terminada en '\0'
...
{
	/*
	    Se devolverá un 1/true o un 0/false según corresponda.
	 */
...
{
	/*
	 Se reciben dos enteros no mayores que 'tamTab'
	 Se devuelve el numero más pequeño.
	 */
